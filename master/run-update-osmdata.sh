...
#     scp "robot@$IP:data/$job/results/*.zip" /data/new/
    cp data/$job/results/*.zip /data/new/
    sync
}
...
#     scp "robot@$IP:data/coastline/osmi.tar.bz2" /data/osmi/
    cp data/coastline/osmi.tar.bz2 /data/osmi/
#     scp -C "robot@$IP:data/coastline/osmi-coastlines.db" /data/osmi/
    cp data/coastline/osmi-coastlines.db /data/osmi/
#     scp "robot@$IP:data/coastline/osmi/*.json.gz" /data/err/
    cp data/coastline/osmi/*.json.gz /data/err/
    sync
...
cp /mnt/data/planet/last-update /data/new/
